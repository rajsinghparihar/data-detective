...
LOGS_DIR = Path(os.path.join(os.getenv("MODEL_DATA_DIR"),"logs"))# Replace with your actual log directory path
...
class CustomLogger:
    ...
    def configure_logger(self, log_file_name=None):
        ...
        if not log_file_name:
            ...
            log_file_name = Path(calling_module).stem  # Use the module name as the log file name
